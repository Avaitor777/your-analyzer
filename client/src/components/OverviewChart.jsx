...
const OverviewChart = ({ isDashboard = false, view}) => {
    ...
    const [totalSalesLine, totalUnitsLine] = useMemo(() => {
        ...
        const totalSalesLine = {
            ...
            data: [],
            //configuration for nivo/lines usage (above format)
        };
        ...
        //calculation part (here, to put into the x and y axis with updation each time)
        ...
        Object.values(monthlyData).reduce(
            ...
            {sales: 0, units: 0} //the updation of x & y here
        );
